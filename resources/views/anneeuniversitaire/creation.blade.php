        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Ajouter une annee universitaire</h4>
                            <p class="card-description">
                                Remplissez les champs ci-dessous pour ajouter une annee universitaire
                            </p>
                            ...
                            @endif
                            <form class="forms-sample"  method="post" action="{{ route('creationanneeuniversitaire') }}" enctype="multipart/form-data">
                                <!-- CROSS Site Request Forgery Protection -->
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputName1">annee universitaire</label>
                                    <input name="annee" type="number" class="form-control" id="nom" placeholder="annee universitaire" required autofocus>
                                </div>
