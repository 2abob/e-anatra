                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive pt-3">
                                <table id="table" class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($allniveau as $allniveau)
                                            <tr>
                                                <td><a href="/ficheniveau/{{$allniveau -> id}}" class="fw-normal mb-1">{{$allniveau -> niveau}}</a></td>
                                                <td>
                                                    <a href="/modifierniveauform/{{$allniveau -> id}}" class="btn btn-outline-info btn-fw" data-mdb-ripple-color="dark">Modifier</a>
                                                    <a href="/supprimerniveau/{{$allniveau -> id}}" class="btn btn-danger" data-mdb-ripple-color="dark">Supprimer</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
