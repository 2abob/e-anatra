...
@section('content_show_all_type_cours')
    <!-- partial -->
                            ...
                            <div class="table-responsive pt-3">
                                <table id="table" class="table align-middle mb-0 bg-white">
                                    ...
                                    @foreach ($all_type_cour as $all_type_cours)
                                        <tr>
                                            <td>
                                                <p class="fw-normal mb-1">{{$all_type_cours -> type_cours}}</p>
                                            </td>

                                            <td>
                                                <a href="/show_student_order_type_cours/{{$all_type_cours -> id}}">
                                                    <button
                                                        type="button"
                                                        class="btn btn-outline-info btn-fw"
                                                        data-mdb-ripple-color="dark"
                                                    >
                                                        Afficher les etudiants de cette types de cours
                                                    </button>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="/update_type_cours/{{$all_type_cours -> id}}">
                                                    <button
                                                        type="button"
                                                        class="btn btn-outline-info btn-fw"
                                                        data-mdb-ripple-color="dark"
                                            ...
                                            <td>
                                                <a href="/delete_type_cours/{{$all_type_cours -> id}}">
                                                    <button
                                                        type="button"
