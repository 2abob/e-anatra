...
@section('content_add_new_type_cours')
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form class="forms-sample" method="post" action="{{ route('update_type_cours.store',$type_cours -> id )}}">
                                <!-- CROSS Site Request Forgery Protection -->
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputName1">Nom du type de cours</label>
                                    <input type="text" class="form-control" placeholder="Nom type de cours" name="type_cours" id="type_cours" required value="{{$type_cours -> type_cours}}">
                                </div>
