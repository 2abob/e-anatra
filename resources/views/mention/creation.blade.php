        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Ajouter un mention</h4>
                            <p class="card-description">
                                Remplissez les champs ci-dessous pour ajouter un mention
                            </p>
                            ...
                            @endif
                            <form class="forms-sample"  method="post" action="{{ route('creationmention') }}" enctype="multipart/form-data">
                                <!-- CROSS Site Request Forgery Protection -->
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputName1">mention</label>
                                    <input name="mention" type="text" class="form-control" id="nom" placeholder="mention" required autofocus>
                                </div>
